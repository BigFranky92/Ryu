...
# under the License. conding=utf-8
import logging
import struct
import copy
...
class NetworkAwareness(app_manager.RyuApp):
    ...
    def _discover(self):
        ...
        while True:
            ...
            if i == 5:
                ...
                i = 0
            hub.sleep(settings.DISCOVERY_PERIOD)
            i = i + 1
    ...
    def show_topology(self):
        ...
        if self.pre_graph != self.graph and settings.TOSHOW:
            print "---------------------Topo Link---------------------"
            print '%10s' % ("switch"),
        ...
        if self.pre_link_to_port != self.link_to_port and settings.TOSHOW:
            print "---------------------Link Port---------------------"
            print '%10s' % ("switch"),
            for i in self.graph.nodes():
                print '%10d' % i,
        ...
        if self.pre_access_table != self.access_table and settings.TOSHOW:
            print "----------------Access Host-------------------"
